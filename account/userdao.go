...
func (d *userDAO) UpsertOnLogin(u *User) error {
	if _, err := d.DB.Exec(`
		INSERT INTO "user" ("uid", "creation_time", "last_login", "twitter_token", "twitter_secret", "twitter_id", "twitter_name")
		...
		ON CONFLICT ("uid") DO UPDATE SET
			...
			"twitter_id" = $6,
			"twitter_name" = $7
	`, u.Uid, u.CreationTime, u.LastLogin, u.TwitterToken, u.TwitterSecret, u.TwitterId, u.TwitterName); err != nil {
		return err
	}
	return nil
}
